...
public final class DrawSky extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        try (InputStream hs = resourceStream("/hygdata_v3.csv"); InputStream hs2 = resourceStream("/asterisms.txt") ){
            ...
            HorizontalCoordinates projCenter =
                    HorizontalCoordinates.ofDeg(180, 23);
            ...
            Transform planeToCanvas =
                    Transform.affine(600, 0, 0, -600, 400, 300);
